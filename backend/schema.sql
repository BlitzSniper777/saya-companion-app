...
DROP TABLE IF EXISTS voice_credits CASCADE;
...
CREATE INDEX idx_gift_transactions_user ON gift_transactions(user_id, created_at DESC);
CREATE INDEX idx_voice_credits_user ON voice_credits(user_id);
