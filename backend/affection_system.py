...
BADGES: dict[int, dict] = {
    10:  {"name": "Ember",       "icon": "🔥", "color": "#f97316",
    ...
    20:  {"name": "Spark",       "icon": "✨", "color": "#a855f7",
    ...
    30:  {"name": "Flame",       "icon": "💫", "color": "#ec4899",
    ...
    40:  {"name": "Heartbound",  "icon": "💗", "color": "#ef4444",
    ...
    50:  {"name": "Soulbound",   "icon": "🌊", "color": "#06b6d4",
    ...
    60:  {"name": "Devotion",    "icon": "⭐", "color": "#eab308",
    ...
    70:  {"name": "Eternal",     "icon": "🌙", "color": "#8b5cf6",
    ...
    80:  {"name": "Transcendent","icon": "🌟", "color": "#f59e0b",
    ...
    90:  {"name": "Divine",      "icon": "👑", "color": "#d4af37",
